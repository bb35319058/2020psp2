...
[comment #20200707]
- 次からはこちらのレポートにソースコードの説明、入出力結果を記入してから課題の提出をお願いします。
- estimation varの答えが間違っています。N/(N-1)*var;という書き方だとNを(N-1)*varで割るという計算になりますので、(N*var)/N-1;とすれば正しい答えが出るでしょう。

[comment #20200714]
- 自分からの修正の指示、アドバイス等は特にありません。引き続き先生に提出をお願いします。